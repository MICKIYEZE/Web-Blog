...
git clone https://github.com/MICKIYEZE/WEB-BLOG-SUT.git
cd WEB-BLOG-SUT
...
## ❗ Troubleshooting
App shows unhealthy
Ensure /health route exists and returns 200.
...
Ensure .env exists and is referenced in docker-compose.yml.
